...
public class AfficherInscriptionController {
    ...
    @FXML
    private TableView<Inscription> table_inscriptions;

    @FXML
    private TableColumn<Inscription, String> col_titre;

    @FXML
    private TableColumn<Inscription, String> col_nom;

    @FXML
    private TableColumn<Inscription, String> col_email;

    @FXML
    private TableColumn<Inscription, String> col_date;

    @FXML
    private TableColumn<Inscription, Void> col_actions;
    ...
    void initActionsColumn() {
        if (col_actions == null)
            return; // au cas où tu n'as pas encore ajouté la colonne
