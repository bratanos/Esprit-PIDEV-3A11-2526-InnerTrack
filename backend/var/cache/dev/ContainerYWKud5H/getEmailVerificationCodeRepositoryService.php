 ...
 */
class getEmailVerificationCodeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmailVerificationCodeRepository' shared autowired service.
     *
     * @return \App\Repository\EmailVerificationCodeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmailVerificationCodeRepository.php';

        return $container->privates['App\\Repository\\EmailVerificationCodeRepository'] = new \App\Repository\EmailVerificationCodeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
