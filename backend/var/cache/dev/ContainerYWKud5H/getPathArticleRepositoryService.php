 ...
 */
class getPathArticleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PathArticleRepository' shared autowired service.
     *
     * @return \App\Repository\PathArticleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PathArticleRepository.php';

        return $container->privates['App\\Repository\\PathArticleRepository'] = new \App\Repository\PathArticleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
