 ...
 */
class getLearningPathRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LearningPathRepository' shared autowired service.
     *
     * @return \App\Repository\LearningPathRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LearningPathRepository.php';

        return $container->privates['App\\Repository\\LearningPathRepository'] = new \App\Repository\LearningPathRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
