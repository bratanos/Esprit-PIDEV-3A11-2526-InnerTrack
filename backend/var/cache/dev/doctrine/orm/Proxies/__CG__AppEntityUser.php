...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'clientProfile' => [parent::class, 'clientProfile', null, 16],
        ...
        "\0".parent::class."\0".'lastLogin' => [parent::class, 'lastLogin', null, 16],
        ...
        "\0".parent::class."\0".'therapistProfile' => [parent::class, 'therapistProfile', null, 16],
        'clientProfile' => [parent::class, 'clientProfile', null, 16],
        ...
        'lastLogin' => [parent::class, 'lastLogin', null, 16],
        ...
        'therapistProfile' => [parent::class, 'therapistProfile', null, 16],
    ];
