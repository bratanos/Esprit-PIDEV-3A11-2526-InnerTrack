 ...
 */
class getSecurity_Authenticator_FormLogin_WebService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.authenticator.form_login.web' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authenticator.form_login.web'])) {
            return $container->privates['security.authenticator.form_login.web'];
        }
        ...
        $instance = new \Symfony\Component\Security\Http\Authenticator\FormLoginAuthenticator($c, ($container->privates['security.user.provider.concrete.app_user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppUserProviderService')), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler(new \App\Security\LoginSuccessHandler(($container->services['router'] ?? self::getRouterService($container)), $a), ['login_path' => 'app_login', 'default_target_path' => 'app_dashboard', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false], 'web'), $d, ['login_path' => 'app_login', 'check_path' => 'app_login', 'username_parameter' => 'email', 'password_parameter' => 'password', 'enable_csrf' => true, 'use_forward' => false, 'require_previous_session' => false, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true, 'form_only' => false]);

        if (isset($container->privates['security.authenticator.form_login.web'])) {
            return $container->privates['security.authenticator.form_login.web'];
        }

        return $container->privates['security.authenticator.form_login.web'] = $instance;
    }
}
