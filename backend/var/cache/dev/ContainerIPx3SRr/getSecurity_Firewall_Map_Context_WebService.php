 ...
 */
class getSecurity_Firewall_Map_Context_WebService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.firewall.map.context.web' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.firewall.map.context.web'])) {
            return $container->privates['security.firewall.map.context.web'];
        }
        ...
        $instance = new \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['debug.security.firewall.authenticator.web'] ?? $container->load('getDebug_Security_Firewall_Authenticator_WebService'));
            yield 3 => ($container->privates['security.access_listener'] ?? $container->load('getSecurity_AccessListenerService'));
        }, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, ($container->privates['security.authentication.trust_resolver'] ??= new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver()), $c, 'web', $a, NULL, NULL, ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $c, ($container->privates['debug.security.event_dispatcher.web'] ?? self::getDebug_Security_EventDispatcher_WebService($container)), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'app_logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('web', 'App\\Security\\UserChecker', NULL, true, false, 'security.user.provider.concrete.app_user_provider', 'web', 'security.authenticator.form_login.web', NULL, NULL, ['form_login', 'remember_me'], NULL, ['path' => 'app_logout', 'target' => 'app_login', 'enable_csrf' => NULL, 'csrf_token_id' => 'logout', 'csrf_parameter' => '_csrf_token', 'invalidate_session' => true, 'clear_site_data' => [], 'delete_cookies' => []]), ($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()));

        if (isset($container->privates['security.firewall.map.context.web'])) {
            return $container->privates['security.firewall.map.context.web'];
        }

        return $container->privates['security.firewall.map.context.web'] = $instance;
    }
}
