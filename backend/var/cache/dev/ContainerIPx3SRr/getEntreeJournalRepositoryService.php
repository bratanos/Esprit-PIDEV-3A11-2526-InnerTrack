 ...
 */
class getEntreeJournalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Journal\EntreeJournalRepository' shared autowired service.
     *
     * @return \App\Repository\Journal\EntreeJournalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Journal'.\DIRECTORY_SEPARATOR.'EntreeJournalRepository.php';

        return $container->privates['App\\Repository\\Journal\\EntreeJournalRepository'] = new \App\Repository\Journal\EntreeJournalRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
