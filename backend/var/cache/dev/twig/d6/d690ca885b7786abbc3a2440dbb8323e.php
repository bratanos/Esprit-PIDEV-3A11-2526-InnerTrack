...
class __TwigTemplate_99b26c0f244caaa14a39486b26e48e6c extends Template
{
    ...
    <div class=\"w-full max-w-3xl lg:max-w-4xl mx-auto px-4 py-4 flex justify-between items-center\">
...
";
    ...
    {
        return new Source("<nav class=\"bg-white shadow\">
    <div class=\"w-full max-w-3xl lg:max-w-4xl mx-auto px-4 py-4 flex justify-between items-center\">
        <a href=\"/\" class=\"text-xl font-bold text-gray-800\">
            InnerTrack
        </a>
