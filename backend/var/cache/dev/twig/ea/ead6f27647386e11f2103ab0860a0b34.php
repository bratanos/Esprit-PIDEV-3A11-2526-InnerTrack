...
class __TwigTemplate_2870d51294f3a11cc11c2e3ebe729b92 extends Template
{
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_article_delete', {'id': article.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ article.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "article/_delete_form.html.twig", "C:\\Users\\wiem\\Desktop\\SYmfonymerged\\Esprit-PIDEV-3A11-2526-InnerTrack\\backend\\templates\\article\\_delete_form.html.twig");
    }
}
