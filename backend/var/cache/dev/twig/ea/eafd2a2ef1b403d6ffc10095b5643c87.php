...
class __TwigTemplate_63d69e7ce54317caad3f77400a97e301 extends Template
{
    ...
    // line 1
    public function macro_resolve_previous_page_message($options = null, ...$varargs): string|Markup
    {
        $macros = $this->macros;
        $context = [
            "options" => $options,
    ...
    // line 9
    public function macro_resolve_next_page_message($options = null, ...$varargs): string|Markup
    {
        $macros = $this->macros;
        $context = [
            "options" => $options,
    ...
    {
        return array (  116 => 13,  113 => 11,  111 => 10,  93 => 9,  80 => 5,  77 => 3,  75 => 2,  57 => 1,);
    }
...
{%- macro resolve_next_page_message(options) -%}
    ...
    {%- endif -%}
{%- endmacro -%}
", "@BabDevPagerfanta/macros.html.twig", "C:\\Users\\wiem\\Desktop\\SYmfonymerged\\Esprit-PIDEV-3A11-2526-InnerTrack\\backend\\vendor\\babdev\\pagerfanta-bundle\\templates\\macros.html.twig");
    }
}
