...
class __TwigTemplate_36e53458f3eb9a3b33842adcefd2fc86 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
     ...
     <div class=\"w-full max-w-3xl lg:max-w-4xl mx-auto px-4 py-4 text-center text-gray-500 text-sm\">
        © ";
        // line 3
...
";
    ...
    {
        return new Source("<footer class=\"bg-white border-t mt-6\">
     <div class=\"w-full max-w-3xl lg:max-w-4xl mx-auto px-4 py-4 text-center text-gray-500 text-sm\">
