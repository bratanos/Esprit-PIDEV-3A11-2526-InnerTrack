...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.WE5u2t6'] ?? self::get_ServiceLocator_WE5u2t6Service($container)), ($container->privates['.service_locator.JOrOeZP'] ?? $container->load('get_ServiceLocator_JOrOeZPService')), ['login' => [($container->privates['security.authenticator.json_login.login'] ?? $container->load('getSecurity_Authenticator_JsonLogin_LoginService'))], 'api' => [($container->privates['security.authenticator.jwt.api'] ?? $container->load('getSecurity_Authenticator_Jwt_ApiService'))], 'web' => [($container->privates['security.authenticator.form_login.web'] ?? $container->load('getSecurity_Authenticator_FormLogin_WebService')), ($container->privates['security.authenticator.remember_me.web'] ?? $container->load('getSecurity_Authenticator_RememberMe_WebService'))]], false);
