 ...
 */
class getSecurity_Listener_UserChecker_WebService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.listener.user_checker.web' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.user_checker.web'] = new \Symfony\Component\Security\Http\EventListener\UserCheckerListener(($container->privates['App\\Security\\UserChecker'] ??= new \App\Security\UserChecker()));
    }
}
