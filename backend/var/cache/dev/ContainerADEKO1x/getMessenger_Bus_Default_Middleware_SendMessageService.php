...
class getMessenger_Bus_Default_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['Symfony\\Component\\Mailer\\Messenger\\SendEmailMessage' => ['sync'], 'Symfony\\Component\\Notifier\\Message\\ChatMessage' => ['sync'], 'Symfony\\Component\\Notifier\\Message\\SmsMessage' => ['sync']], $a), $b, true);
