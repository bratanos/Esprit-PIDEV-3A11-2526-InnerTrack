...
class get_ServiceLocator_Aw9RHlFService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.aw9RHlF'])) {
            return $container->privates['.service_locator.aw9RHlF'];
        }

        return $container->privates['.service_locator.aw9RHlF'] = $instance;
    }
}
