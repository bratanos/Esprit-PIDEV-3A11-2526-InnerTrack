 ...
 */
class getHabitudeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Journal\HabitudeRepository' shared autowired service.
     *
     * @return \App\Repository\Journal\HabitudeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Journal'.\DIRECTORY_SEPARATOR.'HabitudeRepository.php';

        return $container->privates['App\\Repository\\Journal\\HabitudeRepository'] = new \App\Repository\Journal\HabitudeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
