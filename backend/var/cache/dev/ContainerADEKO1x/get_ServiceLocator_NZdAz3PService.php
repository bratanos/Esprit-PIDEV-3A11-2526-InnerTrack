 ...
 */
class get_ServiceLocator_NZdAz3PService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.service_locator.NZdAz3P' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.NZdAz3P'])) {
            return $container->privates['.service_locator.NZdAz3P'];
        }

        return $container->privates['.service_locator.NZdAz3P'] = $instance;
    }
}
